...
const fs = require("fs");
const { R2 } = require("@cloudflare/r2"); // usando R2 SDK ou fetch direto
...
================================================== */
const R2_ACCOUNT_ID = "f530f1401aaabb2e513e985745fe659b"; // sua conta
const R2_ACCESS_KEY = "b0fb8d6bac3fa426f4ed9c6424f25af8"; // access key
const R2_SECRET_KEY = "ca313b89eb9303a1b70a140c2162c89902da2784879b41c3bb5e07609b62f8e9"; // secret key
const R2_BUCKET_NAME = "chat-audio";

const fetch = require("node-fetch"); // vamos usar fetch para upload
...
async function uploadToR2(filePath, fileName) {
  ...
  if (!response.ok) {
    throw new Error("Erro ao enviar para R2: " + response.statusText);
  }
